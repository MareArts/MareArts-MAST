...
bool MAST_calibration_N_stitching() {
    ...
    // live video
    // streams_vector.push_back(cv::VideoCapture(0));
    // streams_vector.push_back(cv::VideoCapture(1));
    // streams_vector.push_back(cv::VideoCapture(2));
