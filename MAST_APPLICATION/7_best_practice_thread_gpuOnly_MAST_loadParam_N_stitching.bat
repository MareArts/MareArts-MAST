@echo off
setlocal
echo Compiling 7_best_practice_thread_gpuOnly_MAST_loadParam_N_stitching.cpp...
...
cl 7_best_practice_thread_gpuOnly_MAST_loadParam_N_stitching.cpp /Fe7_best_practice_thread_gpuOnly_MAST_loadParam_N_stitching.exe ^
   /I "%OPENCV_INCLUDE%" ^
   /I "%CUDA_INCLUDE_PATH%" ^
   /I "%MAST_S2_DLL_PATH%" ^
   /EHsc ^
...
cmd /c "set PATH=%MAST_S2_DLL_PATH%;C:\opencv\x64\vc17\bin;%TBB_DLL_PATH%;%CUDA_BIN%;C:\Windows\system32 && 7_best_practice_thread_gpuOnly_MAST_loadParam_N_stitching.exe"
